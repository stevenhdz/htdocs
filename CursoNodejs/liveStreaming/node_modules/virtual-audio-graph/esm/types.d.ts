...
export type CustomVirtualAudioNodeFactory<P = IVirtualAudioNodeParams> = (_: P) => IVirtualAudioNodeGraph;
...
export type Output = string | number | IOutputObject | Array<number | string | IOutputObject>;
export type VirtualAudioNode = AudioWorkletVirtualAudioNode | CustomVirtualAudioNode | StandardVirtualAudioNode;

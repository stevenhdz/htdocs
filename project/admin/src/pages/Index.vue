...
<div class="q-pa-md">
 <q-btn round color="primary" style="float: right" icon="shopping_cart" @click="layout = true" />
  ...
  <div class="q-pa-md row items-start q-gutter-md" style="width:460px;  float:right;">
    <q-card class="my-card">

      <q-card-section style="width:400px; height:400px;  float:right;">
 <pre>Solicitud de pedidos:</pre>
    <q-card class="my-card">
      <q-card-section >
...
lorem: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
   ...
   methods: {
    ...
    async consult(){
      try {
        const res = await fetch('https://webs-85287-default-rtdb.firebaseio.com/web.json')
        //respuesta
...
var c2 = []
this.xxxx.productos.forEach(element => {c2.push(element)});
this.xx3 = c2

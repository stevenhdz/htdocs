<template>
  <div class="about">
    ...
    <el-button
      type="primary"
      style="float: left"
      v-on:click="$router.push({ path: '/crear/rol' })"
      ...
      <el-table-column fixed="right" label="Operations" width="200">
        <template #default="scope">
          ...
          <el-button
            ...
            size="small"
            v-on:click="
              $router.push({ path: '/editar/rol/' + scope.row.id })
            "
...
export default {
  ...
  methods: {
    deleteOne(id) {
      this.$swal
        .fire({
          title: "Seguro deseas eliminar el rol " + id + " ?",
          text: "",
          icon: "warning",
        ...
        .then((result) => {
          if (result.isConfirmed) {
            this.$swal.fire("Elimando!", "rol " + id, "success");
          }
        });
    },
  },

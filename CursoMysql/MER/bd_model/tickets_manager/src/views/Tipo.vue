<template>
  <div class="about">
    ...
    <el-button
      type="primary"
      style="float: left"
      v-on:click="$router.push({ path: '/crear/tipo' })"
      ...
      <el-table-column fixed="right" label="Operations" width="200">
        <template #default="scope">
          ...
          <el-button
            ...
            size="small"
            v-on:click="
              $router.push({ path: '/editar/tipo/' + scope.row.id })
            "
...
export default {
  ...
  methods: {
    deleteOne(id) {
      this.$swal
        .fire({
          title: "Seguro deseas eliminar el tipo " + id + " ?",
          text: "",
          icon: "warning",
        ...
        .then((result) => {
          if (result.isConfirmed) {
            this.$swal.fire("Elimando!", "tipo " + id, "success");
          }
        });
    },
  },

...
/* 
$filename="/Users/alexanderjimenez/Downloads/Factura.pdf";
 $pdf->Output($filename,'F'); */

$nombre_mac = '/Users/alexanderjimenez/Downloads/Factura.pdf';
//compartido por windows para iniciar por hamachi ftp o smb como server a la ruta destino
$nombre_windows = '/Volumes/Users/MARIA CAMILA/Downloads/Factura.pdf';
$nombre_linux = '/inicio/alexanderjimenez/Downloads/Factura.pdf';

 if($nombre_mac){
      $pdf->Output($nombre_mac,'F');
 }if($nombre_windows){
      $pdf->Output($nombre_windows,'F');
 }elseif($nombre_linux){
      $pdf->Output($nombre_linux,'F');
 }else{
      echo 'no existe';
 }

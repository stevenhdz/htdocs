...
<!DOCTYPE html>
<html lenguaje="en" lang="es" dir="ltr">
  <head>
  <meta charset="UTF-8">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <!-- traido desde ajax -->
                  <img src="../files/usuarios/<?php echo $_SESSION['imagen'];?>" width="60" height="60" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <button class="translate" id="es"><img src="../public/images/spain.png" width="30" height="30"></button>
                      ...
                      <a href="../vistas/config.php" class="btn btn-default btn-flat"><i class="fa fa-sign-out" aria-hidden="true"></i>Config</a>
                      <a href="../ajax/usuario.php?op=salir" class="btn btn-default btn-flat"><i class="fa fa-sign-out" aria-hidden="true"></i>Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>

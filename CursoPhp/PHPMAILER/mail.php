...
function enviarEmail(){
    if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['comment'])){
        ...
        try {
            ...
            $mail->Password = 'tuclave';                           // SMTP password
            $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
            $mail->Port = 587;                                    // TCP port to connect to

            //Recipients
            $mail->setFrom('mariasistentevirtual@gmail.com', 'Mailer desde');
            $mail->addAddress('mariasistentevirtual@gmail.com', 'Mailer este');     // Add a recipient

new Vue({
    ...
    methods: {
        updateUser(){
          ...
          axios.put('http://localhost:8888/rest/api/update',params,
          {
            headers: { 
              'Authorization': token
            }
        ...
        deleteUser(){
          ...
          if(token == 'Basic bWl1c3VhcmlvOm1pcGFzcw=='){
            ...
            axios.delete('http://localhost:8888/rest/api/destroy/'+ this.id,{
              headers: { 
                'Authorization': token
              }
            })
        ...
        listUser(){
          ...
          this.users = [];
            ...
            axios.get('http://localhost:8888/rest/api/users',
            {
              headers: { 
                'Authorization': token
              }
        ...
        listUsers(){
          ...
          this.users = [];
            ...
            axios.get('http://localhost:8888/rest/api/user/'+ this.id,{
              headers: { 
                'Authorization': token
              }
            })
        ...
        addUser(){
          ...
          if(token == 'Basic bWl1c3VhcmlvOm1pcGFzcw=='){
            ...
            axios.post('http://localhost:8888/rest/api/store',params,{
              headers: { 
                'Authorization': token
              }
            })

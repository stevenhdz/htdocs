...
class ProyectoInvestigacionController extends Controller
{
    ...
    {
        $proyectoInvestigacion = ProyectoInvestigacion::all();
    ...
    {
        $proyectoInvestigacion = new ProyectoInvestigacion();
    ...
    {
        $proyectoInvestigacion = ProyectoInvestigacion::findOrFail($request->idProyecto);
        $proyectoInvestigacion->nombre = $request->nombre;
        $proyectoInvestigacion->detalles = $request->detalles;
        $proyectoInvestigacion->fechaApertura = $request->fechaApertura;
        $proyectoInvestigacion->fechaCierre = $request->fechaCierre;
    ...
    {
        $proyectoInvestigacion = ProyectoInvestigacion::destroy($request->idProyecto);
        return $proyectoInvestigacion;
    }
}
